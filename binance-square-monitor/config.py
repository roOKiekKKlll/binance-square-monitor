...
TRADING_ORDER_AMOUNT = 12.0              # fixed_margin 模式下的固定保证金（12U x 10x = 约120U名义）
TRADING_FIXED_MARGIN_HALF_MULTIPLIER = 1.0  # fixed_margin 下 half 档保证金倍率（1.0=half 也按 12U 下单）
TRADING_MIN_NOTIONAL = 5.0               # 名义价值下限，低于此值不开仓（避免滑点放大）
TRADING_MAX_NOTIONAL_PCT = 50.0          # 单笔名义价值不超过账户净值的百分比

# --- 风控硬限制 ---
TRADING_MAX_CONCURRENT_POSITIONS = 7     # 最多同时 7 个仓位
...
LIVE_MAX_TOTAL_EXPOSURE_USD = 900.0      # 总敞口硬限（USD）
